...
for iteration in range(max_iterations):
    ...
    for t in range(1,T):
        for j in range(J):
            ...
            objective_expr += lambda_i1jt1[j, t]*(h_jt[j, t-1]+O[j,t]-h_jt[j,t]-F_jt[j,t]-V_jt[j, t] )
            for i1 in range(I1):
    ...
    for j in range(J):
        for t in range(1,T):
            ...
            erlfa1 = (h_jt1_value + O_value - l1_total - l2_total - h_jt_value - F_jt_value - V_jt_value) ** 2
            if erlfa1==0:
                lambda_i1jt1[j,t] =  lambda_i1jt1[j,t]
            # erlfa2 = (R_j[j] * l_value - hv_i1_max[i])**2
            objective_value = objective_expr.getValue()
            sete[j,t] = ( -2337619.8- objective_value) / erlfa1
            # sete[j, t] = ( -1554456- objective_value) / erlfa1
            fm = h_jt1_value+O_value-V_jt_value-l1_total-l2_total-h_jt_value-F_jt_value
