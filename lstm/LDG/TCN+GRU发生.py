...
xiaohao_data = pd.read_csv(r'E:\新建文件夹\代码\lstm\data\LDG\LDGFSL.csv')
...
df_result.to_excel('TCN+GRULDG发生.xlsx', index=False)
...
df_metrics.to_excel('TCN+GRULDG发生数据.xlsx', index=False)
plt.show()
