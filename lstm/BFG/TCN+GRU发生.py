...
model_gru.add(TCN(nb_filters=128, kernel_size=3, nb_stacks=1, dilations=[1, 2, 4, 8, 16, 32], padding='causal', use_skip_connections=True, dropout_rate=0.01, return_sequences=True, activation='tanh'))
...
df_result.to_excel('TCN+GRUBFG发生.xlsx', index=False)
...
df_metrics.to_excel('TCN+GRUBFG发生数据.xlsx', index=False)